...
f_pkg() {
  PKG_PACMAN="$PKG_PACMAN_BASE $PKG_PACMAN_DESKTOP $PKG_PACMAN_EDUC $PKG_PACMAN_GNOME $PKG_PACMAN_GRAPHIC $PKG_PACMAN_INTERNET $PKG_PACMAN_JEUX $PKG_PACMAN_MEDIA $PKG_PACMAN_MTP $PKG_PACMAN_PRINT $PKG_PACMAN_XFCE $PKG_PACMAN_WINE"

#$PKG_PACMAN_NVIDIA
#$PKG_PACMAN_PORTABLE
#$PKG_PACMAN_VIRTUAL

  PKG_YAOURT="$PKG_YAOURT_BASE $PKG_YAOURT_DESKTOP $PKG_YAOURT_EDUC $PKG_YAOURT_GRAPHIC $PKG_YAOURT_INTERNET $PKG_YAOURT_JEUX $PKG_YAOURT_MEDIA $PKG_YAOURT_MTP $PKG_YAOURT_XFCE"
#$PKG_YAOURT_VIRTUAL
}
